            ...
            <div
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-24 lg:py-32 text-center text-yellow-500">
                    <div className="mt-12 sm:mt-20 md:mt-28 lg:mt-40">
                        ...
                        <button className=" cursor-pointer bg-[#c09441] text-xl sm:text-2xl md:text-3xl lg:text-4xl px-6 sm:px-8 md:px-10 rounded-2xl text-gray-200 font-bold py-2 sm:py-3 md:py-4">Hot Deals <span className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl">🔥</span></button>
                    </div>
                </div>
            </div>
        </section>
